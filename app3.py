...
def main():
    ...
    if st.button("Get Insights"):
        query = user_query + """ Please provide the final command and its output in the following format:
                                "Command:" followed by the command,
                                and "Output:" followed by a detailed and clean textual summary explaining the results, and the DataFrame content separated clearly. """
